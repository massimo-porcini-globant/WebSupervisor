...
### Task
- [ ] E2.1 CRUD progetti (Zod shared) + RBAC + archiviazione/ripristino
- [ ] E2.2 Elenco filtrabile (stato/priorità/team) + paginazione
- [ ] E2.4 Dominio avanzamento (AD-6) + test unit
- [ ] E2.3 UI Dashboard conforme M1 + login + filtri + KPI + stato vuoto
